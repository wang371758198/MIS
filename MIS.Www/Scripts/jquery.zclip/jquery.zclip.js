            ...
            return this.each(function () {
                ...
                if (o.is(':visible') && (typeof settings.copy == 'string' || jQuery.isFunction(settings.copy))) {
                    ...
                    clip.addEventListener('mouseDown', function (client) {
                        ...
                        if (!jQuery.isFunction(settings.copy)) {
                           // console.log("settings.copy:" + settings.copy);
                            clip.setText(settings.copy);
                        } else {
                           // console.log(o);
                           // console.log("o.triggerHandler('zClip_copy'):" + o.triggerHandler('zClip_copy'));
...
ZeroClipboard.Client.prototype = {
    ...
    setText: function (newText) {
        ...
        if (this.ready) {
           ...
           // console.log("newText movie.setText:" + newText);
    ...
    receiveEvent: function (eventName, args) {
        ...
        case 'load':
            ...
            try {
                //console.log(this.movie);
               /// console.log("clipText: movie.setText:" + this.clipText)
